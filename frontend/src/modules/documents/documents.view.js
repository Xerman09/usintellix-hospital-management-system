...
<div class="docs-page">
    ...
    <div style="display: flex; gap: 8px; padding: 0 40px 16px; border-bottom: 1px solid #e2e8f0; margin-bottom: 24px;">
        <button type="button" id="docsSignatureOpenBtn" class="btn-secondary" style="flex: 1; font-weight: 500; display: flex; justify-content: center; align-items: center;">
        ...
        <div style="position: relative; display: inline-block; flex: 1;" id="docsSelectFormContainer">
            <button type="button" id="docsSelectFormBtn" class="btn-secondary" style="width: 100%; font-weight: 500; display: flex; justify-content: center; align-items: center;">
            ...
            <div id="docsSelectFormDropdown" class="docs-form-dropdown" style="display: none; position: absolute; top: 100%; left: 0; right: 0; border: 1px solid #e2e8f0; box-shadow: 0 4px 6px -1px rgba(0, 0, 0, 0.1); min-width: 100%; z-index: 50; margin-top: 4px;">
                <div style="background: #0f172a; color: white; padding: 8px 12px; font-weight: 600; font-size: 14px; text-align: center;">General</div>
                <a href="#" class="docs-form-option" data-form="hipaa" style="display: block; padding: 10px 16px; text-decoration: none; font-size: 14px; border-bottom: 1px solid #f1f5f9;">Hipaa Document</a>
                <a href="#" class="docs-form-option" data-form="insurance" style="display: block; padding: 10px 16px; text-decoration: none; font-size: 14px; border-bottom: 1px solid #f1f5f9;">Insurance Info</a>
                <a href="#" class="docs-form-option" data-form="medical" style="display: block; padding: 10px 16px; text-decoration: none; font-size: 14px; border-bottom: 1px solid #f1f5f9;">Medical History</a>
                <a href="#" class="docs-form-option" data-form="privacy" style="display: block; padding: 10px 16px; text-decoration: none; font-size: 14px;">Privacy Document</a>
            </div>
        </div>
        <button type="button" class="btn-secondary" id="docsSaveDraftBtn" style="flex: 1; font-weight: 500; display: flex; justify-content: center; align-items: center; display: none;">
            Save as Draft
        </button>
        <button type="button" class="btn-secondary" id="docsSubmitCompletedBtn" style="flex: 1; font-weight: 500; display: flex; justify-content: center; align-items: center; display: none;">
            Submit Completed
        </button>
        <button type="button" id="docsActivitiesBtn" class="btn-secondary" style="flex: 1; font-weight: 500; display: flex; justify-content: center; align-items: center;">
    ...
    <div class="docs-editing-bar" id="docsEditingBar">
        <div class="docs-editing-dot"></div>
        <span class="docs-editing-label">Editing Document</span>
    </div>
