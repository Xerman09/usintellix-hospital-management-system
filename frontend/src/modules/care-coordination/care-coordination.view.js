export function CareCoordinationView() {
    ...
    <div class="report-wrapper fade-in" style="padding: 24px; max-width: 1400px; margin: 0 auto; display: flex; flex-direction: column; gap: 16px;">
        ...
        <div style="border-bottom: 1px solid #cbd5e1; margin-bottom: 8px;">
            <div id="careCoordinationMainTabs" style="display: flex; gap: 8px;">
                <button type="button" data-main-target="export" class="main-tab-link active" style="padding: 8px 16px; border: 1px solid #cbd5e1; border-bottom: none; background: white; color: #3b82f6; cursor: pointer;">Export</button>
                <button type="button" data-main-target="import" class="main-tab-link" style="padding: 8px 16px; border: 1px solid transparent; background: transparent; color: #64748b; cursor: pointer;">Import</button>
            </div>
        </div>

        <div id="section-export" style="display: block;">
            <!-- Sub Tabs -->
        ...
        <div id="section-import" style="display: none;">
            <!-- Sub Tabs -->
            <div id="importSubTabs" style="display: flex; gap: 16px; border-bottom: 1px solid #cbd5e1; padding-bottom: 0px; margin-bottom: 8px;">
                <a href="javascript:void(0)" data-target="import-ccd" class="import-sub-tab-link active" style="color: #3b82f6; text-decoration: none; font-weight: 500; border-bottom: 2px solid #3b82f6; padding-bottom: 7px;">CCD</a>
                <a href="javascript:void(0)" data-target="import-ccr" class="import-sub-tab-link" style="color: #64748b; text-decoration: none; padding-bottom: 7px;">CCR</a>
                <a href="javascript:void(0)" data-target="import-ccda" class="import-sub-tab-link" style="color: #64748b; text-decoration: none; padding-bottom: 7px;">CCDA or QRDA Cat I</a>
            </div>

            <!-- Import CCD Content -->
            <div id="content-import-ccd" class="import-tab-content" style="display: block;">
                <div style="display: flex; justify-content: flex-end; align-items: center; background-color: #f1f5f9; padding: 12px 16px; border: 1px solid #e2e8f0; margin-bottom: 16px; gap: 12px;">
                    <button type="button" class="btn-icon" style="background-color: #06b6d4; color: white; border: none; border-radius: 50%; width: 32px; height: 32px; display: flex; align-items: center; justify-content: center; cursor: pointer;">
            ...
            <!-- Import CCR Content -->
            <div id="content-import-ccr" class="import-tab-content" style="display: none;">
                <div style="display: flex; justify-content: flex-end; align-items: center; background-color: #f1f5f9; padding: 12px 16px; border: 1px solid #e2e8f0; margin-bottom: 16px; gap: 12px;">
                    <button type="button" class="btn-icon" style="background-color: #06b6d4; color: white; border: none; border-radius: 50%; width: 32px; height: 32px; display: flex; align-items: center; justify-content: center; cursor: pointer;">
                        <svg viewBox="0 0 24 24" width="16" height="16" stroke="currentColor" stroke-width="2" fill="none"><polyline points="23 4 23 10 17 10"></polyline><polyline points="1 20 1 14 7 14"></polyline><path d="M3.51 9a9 9 0 0 1 14.85-3.36L23 10M1 14l4.64 4.36A9 9 0 0 0 20.49 15"></path></svg>
                    </button>
            ...
            <!-- Import CCDA Content -->
            <div id="content-import-ccda" class="import-tab-content" style="display: none;">
                <div style="display: flex; justify-content: flex-end; align-items: center; background-color: #f1f5f9; padding: 12px 16px; border: 1px solid #e2e8f0; margin-bottom: 16px; gap: 12px;">
                    <button type="button" class="btn-icon" style="background-color: #06b6d4; color: white; border: none; border-radius: 50%; width: 32px; height: 32px; display: flex; align-items: center; justify-content: center; cursor: pointer;">
                        <svg viewBox="0 0 24 24" width="16" height="16" stroke="currentColor" stroke-width="2" fill="none"><polyline points="23 4 23 10 17 10"></polyline><polyline points="1 20 1 14 7 14"></polyline><path d="M3.51 9a9 9 0 0 1 14.85-3.36L23 10M1 14l4.64 4.36A9 9 0 0 0 20.49 15"></path></svg>
                    </button>
