export function CareCoordinationView() {
    ...
    <div class="report-wrapper fade-in" style="padding: 24px; max-width: 1400px; margin: 0 auto; display: flex; flex-direction: column; gap: 16px;">
        ...
        <!-- Sub Tabs -->
        <div style="display: flex; gap: 16px; border-bottom: 1px solid #cbd5e1; padding-bottom: 8px; margin-bottom: 8px;">
            <a href="#" style="color: #3b82f6; text-decoration: none; font-weight: 500;">CCDA or QRDA</a>
            <a href="#" style="color: #64748b; text-decoration: none;">Immunization</a>
            <a href="#" style="color: #64748b; text-decoration: none;">Syndromic Surveillance</a>
        </div>

        <!-- Action Bar -->
        <div style="display: flex; justify-content: space-between; align-items: center; background-color: #f8fafc; padding: 12px 16px; border-radius: 6px; border: 1px solid #e2e8f0;">
