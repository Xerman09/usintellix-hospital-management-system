            ...
            container.innerHTML = `
                <div style="font-family: inherit; font-size: 14px; line-height: 1.6; color: #1e293b;">
                    <div style="margin-bottom: 20px;">
                        ...
                        <a style="color: #4f46e5; text-decoration: underline; cursor: pointer; margin-left: 6px; font-size: 13px;" id="summaryEditBtn">(edit)</a>
                    </div>
                    ...
                    <div style="margin-bottom: 24px;">
                        <div style="font-weight: 700; font-size: 15px; color: #0f172a; margin-bottom: 8px;">
                            Reminder intervals <span style="color: #4f46e5; font-size: 13px; font-weight: normal;">(edit)</span>
                        </div>
                    ...
                    <div style="margin-bottom: 24px;">
                        <div style="font-weight: 700; font-size: 15px; color: #0f172a; margin-bottom: 8px;">
                            Demographics filter criteria <span style="color: #4f46e5; font-size: 13px; font-weight: normal;">(add)</span>
                        </div>
                        <table style="width: 100%; border-collapse: collapse; background: #f8fafc; border: 1px solid #e2e8f0; border-radius: 8px; overflow: hidden;">
                            <thead>
                                <tr style="background: #f1f5f9; text-align: left;">
                                ...
                                ${demoList.map(item => `
                                    <tr>
                                        ...
                                        <td style="padding: 10px 14px; text-align: center;">
                                            <span style="color: #4f46e5; font-size: 12px; cursor: pointer; margin-right: 6px;">(edit)</span>
                    ...
                    <div style="margin-bottom: 16px;">
                        ...
                        <div style="margin-bottom: 16px;">
                            <div style="font-weight: 700; font-size: 14px; color: #0f172a; margin-bottom: 8px;">
                                Clinical targets <span style="color: #4f46e5; font-size: 13px; font-weight: normal;">(add)</span>
                            </div>
                            <table style="width: 100%; border-collapse: collapse; background: #f8fafc; border: 1px solid #e2e8f0; border-radius: 8px; overflow: hidden;">
                                <thead>
                                    <tr style="background: #f1f5f9; text-align: left;">
                        ...
                        <div>
                            <div style="font-weight: 700; font-size: 14px; color: #0f172a; margin-bottom: 8px;">
                                Actions <span style="color: #4f46e5; font-size: 13px; font-weight: normal;">(add)</span>
                            </div>
                            <table style="width: 100%; border-collapse: collapse; background: #f8fafc; border: 1px solid #e2e8f0; border-radius: 8px; overflow: hidden;">
                                <thead>
                                    <tr style="background: #f1f5f9; text-align: left;">
