export function Icd10DiagnosesView()
{
    return `
<style>
.icd-page {
...
<div class="icd-page">
    <div class="icd-card">
        <div class="icd-header">
            <div class="icd-header-title">
                <div class="icd-icon-badge">
                    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8Z"></path><path d="M14 2v6h6M9 13h6M9 17h6M9 9h1"></path></svg>
                </div>
                <div>
                    <h1>ICD10 Diagnosis</h1>
                    <p class="form-subtitle">Diagnosis codes registered here become available anywhere clinical records need coding.</p>
                </div>
            </div>
            <button type="button" class="icd-add-btn" id="openAddIcd10Modal">
        ...
        <div class="icd-toolbar">
            <span class="icd-stat-pill" id="icd10CountPill">
                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8Z"></path><path d="M14 2v6h6"></path></svg>
                <span id="icd10CountText">0 codes</span>
            </span>
            <div class="icd-search-wrap">
                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="11" cy="11" r="7"></circle><path d="m21 21-4.3-4.3"></path></svg>
                <input type="text" class="icd-search-input" id="icd10Search" placeholder="Search by code or description...">
                <button type="button" class="icd-search-clear" id="icd10SearchClear" aria-label="Clear search">&times;</button>
            </div>
        </div>
        ...
        <div class="icd-table-wrap">
            <table class="icd-table">
                ...
                <tbody id="icd10TableBody">
                    <tr class="icd-skeleton-row"><td colspan="3"><div class="icd-skeleton-bar" style="width: 60%;"></div></td></tr>
                    <tr class="icd-skeleton-row"><td colspan="3"><div class="icd-skeleton-bar" style="width: 45%;"></div></td></tr>
...
<div class="modal-overlay" id="icd10ModalOverlay">
    <div class="modal-box">
        ...
        <div class="modal-header">
            <h2 id="icd10ModalTitle">Add Diagnosis Code</h2>
            <button type="button" class="modal-close" id="closeIcd10Modal">&times;</button>
        </div>
        <p class="form-subtitle">Define an ICD10 diagnosis code available for clinical coding.</p>
        ...
        <form id="icd10Form">
            ...
            <div class="form-grid">
                <div class="form-group">
                    <label>Code</label>
                    <input id="code" class="form-input icd-code-input" placeholder="e.g A00.0">
                    <span class="form-error" id="err-code"></span>
                </div>

                <div class="form-group full">
                    <label>Description</label>
                    <input id="description" class="form-input" placeholder="e.g Cholera due to Vibrio cholerae 01, biovar cholerae">
                    <span class="form-error" id="err-description"></span>
                </div>
            </div>

            <div class="form-actions">
                <button type="button" class="btn-secondary" id="cancelIcd10">Cancel</button>
                <button class="login-btn" type="submit" id="saveIcd10Btn">Add Diagnosis Code</button>
            </div>
        </form>
    </div>
</div>
