...
<div class="vc-page">
    <div class="vc-card">
        <div class="vc-header">
            <div class="vc-header-title">
                ...
                <div>
                    ...
                    <p class="form-subtitle">Categories registered here are used to classify providers within the system.</p>
                </div>
            </div>
            <button type="button" class="vc-add-btn" id="openAddProviderCategoryModal">
        ...
        <div class="vc-toolbar">
            <span class="vc-stat-pill" id="providerCategoryCountPill">
                ...
                <span id="providerCategoryCountText">0 categories</span>
            </span>
            <div class="vc-search-wrap">
                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="11" cy="11" r="7"></circle><path d="m21 21-4.3-4.3"></path></svg>
                <input type="text" class="vc-search-input" id="providerCategorySearch" placeholder="Search categories...">
                <button type="button" class="vc-search-clear" id="providerCategorySearchClear" aria-label="Clear search">&times;</button>
            </div>
        </div>
        ...
        <div class="vc-table-wrap">
            <table class="vc-table">
                ...
                <tbody id="providerCategoriesTableBody">
...
<div class="modal-overlay" id="providerCategoryModalOverlay">
    <div class="modal-box">
        <div class="vc-modal-icon">
            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"></path><circle cx="9" cy="7" r="4"></circle><path d="M23 21v-2a4 4 0 0 0-3-3.87"></path><path d="M16 3.13a4 4 0 0 1 0 7.75"></path></svg>
        </div>
        <div class="modal-header">
            <h2 id="providerCategoryModalTitle">Add Provider Category</h2>
            <button type="button" class="modal-close" id="closeProviderCategoryModal">&times;</button>
        </div>
        <p class="form-subtitle">Define a category used to classify providers.</p>

        <div id="formAlert"></div>

        <form id="providerCategoryForm">
            <input type="hidden" id="provider_category_id">
            <div class="form-grid">
                <div class="form-group full">
                    <label>Name</label>
                    <input id="name" class="form-input" placeholder="e.g Physician">
            ...
            <div class="form-actions">
                <button type="button" class="btn-secondary" id="cancelProviderCategory">Cancel</button>
                <button class="login-btn" type="submit" id="saveProviderCategoryBtn">Add Provider Category</button>
            </div>
        </form>
    </div>
</div>
