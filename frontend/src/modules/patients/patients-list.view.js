    ...
    <div class="pat-card">
        <div class="pat-header">
            ...
            <div style="display:flex;align-items:center;gap:10px;">
                <button type="button" class="btn btn-outline" id="exportConfidentialRegistryBtn" style="display:inline-flex;align-items:center;gap:6px;height:34px;padding:0 12px;border:1px solid #cbd5e1;border-radius:6px;background:#fff;color:#334155;font-weight:600;font-size:12.5px;cursor:pointer;" title="Download 45 CFR § 164.522(b) Confidential Communications Registry (CSV)">
                    ...
                    Export Confidential Registry (CSV)
                </button>
                ${canAdd ? `
...
<style>
/* Sharp corners, compact tabs, and tightened form-input sizing now come
   from the global .modal-box / .modal-tab / .modal-box .form-input rules
   in main.css -- only this modal's genuine deltas from that default are
   declared here. */
            ...
            <div class="modal-tab-panel" data-panel="choices">
                ...
                <div class="form-grid">
                    ...
                    <div class="form-group">
                        ...
                        <select id="edit_allow_voicemail" class="form-input">
                            <option value="">Unassigned</option>
                            <option value="yes">Yes</option>
                ...
                <div class="form-grid">
                    <div class="form-group">
                        ...
                        <select id="edit_preferred_contact_method" class="form-input">
                    ...
                    <div class="form-group">
                        ...
                        <input id="edit_confidential_address_line" class="form-input" placeholder="e.g. P.O. Box 4502 or Alternative Street">
                        <span class="form-error"></span>
                    </div>

                    <div class="form-group">
                        <label>Confidential City</label>
                        <input id="edit_confidential_city" class="form-input" placeholder="City">
                        <span class="form-error"></span>
                    </div>

                    <div class="form-group">
                        <label>Confidential State / Province</label>
                        <input id="edit_confidential_state" class="form-input" placeholder="State / Province">
                        <span class="form-error"></span>
                    </div>

                    <div class="form-group">
                        <label>Confidential Postal / Zip Code</label>
                        <input id="edit_confidential_postal_code" class="form-input" placeholder="Zip / Postal Code">
                        <span class="form-error"></span>
                    </div>

                    <div class="form-group">
                        <label>Confidential Direct Phone</label>
                        <input id="edit_confidential_phone" class="form-input" placeholder="e.g. Private Cell Phone">
                        <span class="form-error"></span>
                    </div>

                    <div class="form-group">
                        <label>Confidential Direct Email</label>
                        <input id="edit_confidential_email" type="email" class="form-input" placeholder="e.g. secure.personal@example.com">
                        <span class="form-error"></span>
                    </div>
                </div>
                ...
                <div class="form-grid" style="grid-template-columns:1fr;margin-top:8px;">
                    <div class="form-group">
                        ...
                        <textarea id="edit_communication_restrictions_notes" class="form-input" rows="2" placeholder="e.g., Only call cell phone after 5 PM; never leave messages with family members; do not reference medical clinic on voicemail."></textarea>
                        <span class="form-error"></span>
                    </div>
                </div>
            </div>
...
.pd-transfer-section-label {
    font-weight: 600;
    font-size: 13px;
    color: var(--text-primary);
}

.pd-transfer-field-label {
    font-size: 12px;
    font-weight: 600;
    color: var(--text-primary);
    margin-bottom: 4px;
...
.pd-transfer-link:hover {
    text-decoration: underline;
}

:root[data-theme="dark"] .pd-transfer-link {
    color: var(--accent-text, #93c5fd);
}

.pd-transfer-encounters-list {
    max-height: 180px;
    overflow-y: auto;
    border: 1px solid var(--border-color);
    border-radius: 6px;
...
.pd-transfer-enc-row:last-child {
    border-bottom: none;
}

.pd-transfer-enc-row:hover {
    background: var(--bg-surface);
}

:root[data-theme="dark"] .pd-transfer-enc-row:hover {
    background: rgba(255, 255, 255, 0.06);
}

.pd-transfer-enc-title {
    font-weight: 600;
    color: var(--text-primary);
}
...
:root[data-theme="dark"] .pd-transfer-enc-cat {
    color: var(--accent-text, #93c5fd);
}
...
.pd-transfer-enc-sub strong {
    color: var(--text-primary);
}

.pd-transfer-checkbox-label {
    display: flex;
    align-items: center;
    gap: 6px;
    cursor: pointer;
...
.pd-transfer-checkbox-label span {
    color: var(--text-primary);
}
...
.pd-transfer-presets .pd-report-btn {
    font-size: 11px;
    padding: 4px 10px;
    border-radius: 6px;
    background: var(--bg-surface);
...
:root[data-theme="dark"] .pd-transfer-presets .pd-report-btn {
    background: var(--bg-surface);
    border-color: var(--border-color);
    color: var(--text-primary);
}

.pd-transfer-presets .pd-report-btn:hover,
:root[data-theme="dark"] .pd-transfer-presets .pd-report-btn:hover,
.pd-transfer-presets .pd-report-btn.active,
:root[data-theme="dark"] .pd-transfer-presets .pd-report-btn.active {
    background: var(--accent) !important;
    color: #ffffff !important;
    border-color: var(--accent) !important;
}

:root[data-theme="dark"] .pd-transfer-card .form-input {
    background: var(--bg-surface);
    border-color: var(--border-color);
    color: var(--text-primary);
}
        ...
        <div class="pd-body">
            <div class="pd-sidebar">
                ...
                <div class="pd-quick-actions">
                    ...
                    <button type="button" class="pd-quick-btn" id="pdEditDemographicsBtn">
                        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M17 3a2.85 2.83 0 1 1 4 4L7.5 20.5 2 22l1.5-5.5Z"></path></svg>
                        Edit Demographics
                    </button>
                    <button type="button" class="pd-quick-btn" id="pdScheduleAppointmentBtn">
            ...
            <div class="pd-main">
                ...
                <div class="pd-transactions-panel" id="pdTransactionsPanel" style="display: none;">
                    <div id="pdTransactionsListState">
                        <div class="pd-report-card-header">
                            <h3 id="pdTransactionsListTitle">Patient Transactions</h3>
                        </div>
                        <div class="form-actions" style="justify-content:flex-start; gap:10px; margin-bottom:16px;">
                            <button type="button" class="login-btn" id="pdTransactionsNewBtn">+ Create New Transaction</button>
                            <button type="button" class="btn-secondary" id="pdTransactionsBlankFormBtn">Print Blank Referral Form</button>
                        </div>
                        <div id="pdTransactionsListBody">
                            <p class="pd-chart-nav-empty">Loading...</p>
                        </div>
                    </div>

                    <form id="pdTransactionsForm" style="display:none;">
                        <div class="pd-report-card-header">
                            <h3 id="pdTransactionsFormTitle">Add/Edit Patient Transaction</h3>
                        </div>
                        <div class="form-actions" style="justify-content:flex-start; gap:10px; margin-bottom:16px;">
                            <button type="submit" class="login-btn">Save</button>
                            <button type="button" class="btn-secondary" id="pdTransactionsCancelBtn">Cancel</button>
                        </div>
                ...
                <div class="pd-transactions-panel" id="pdIssuesPanel" style="display: none;">
                    ...
                    <div class="pd-report-card">
                        <div class="pd-report-card-header">
                            <h3>Allergies</h3>
                            <div class="pd-report-header-actions">
                                <button type="button" class="pd-report-btn" id="pdIssuesAllergiesAddBtn">+ Add</button>
                                <button type="button" class="pd-report-btn pd-report-btn-secondary" id="pdIssuesAllergiesDeleteBtn" disabled>Delete</button>
                            </div>
                        </div>
                        <div id="pdIssuesAllergiesListBody">
                            <p class="pd-chart-nav-empty">Loading...</p>
                        </div>
                    </div>
                ...
                <div class="pd-transactions-panel" id="pdEncounterSummaryPanel" style="display: none;">
                    ...
                    <div class="pd-report-card" id="pdEncSummaryClinicalNotesCard">
                        <div class="pd-report-card-header">
                            <h3>
                                <button type="button" class="pd-card-collapse-toggle" id="pdEncSummaryClinicalNotesToggle" aria-label="Toggle section">
                                    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" width="14" height="14"><path d="m6 9 6 6 6-6"></path></svg>
                                </button>
                                Clinical Notes Form <span class="pd-locked-badge" id="pdEncSummaryClinicalNotesLockedBadge" style="display:none;">&#128274; Locked</span>
                            </h3>
                            <div class="pd-report-header-actions">
                                <button type="button" class="pd-report-btn" id="pdClinicalNotesAddBtn">+ Add</button>
                                <button type="button" class="pd-report-btn pd-report-btn-secondary" id="pdEncSummaryClinicalNotesSignBtn">eSign</button>
                                <button type="button" class="pd-report-btn pd-report-btn-secondary" id="pdEncSummaryClinicalNotesDeleteBtn">Delete</button>
                            </div>
                        </div>
                        <div class="pd-report-card-body" id="pdEncSummaryClinicalNotesCardBody">
                            <div class="table-wrap">
                                <table class="data-table">
                                    <thead>
                                        <tr>
                                    ...
                                    <tbody id="pdClinicalNotesTableBody">
                                        <tr><td colspan="7" class="table-empty">Loading...</td></tr>
                                    </tbody>
                                </table>
                            </div>
                            ...
                            <div class="pd-esign-log-wrap">
                                <table class="data-table pd-esign-log-table">
                                    <thead><tr><th>Signer</th><th>Role</th><th>Amendment</th><th>Signed At</th></tr></thead>
                                    <tbody id="pdEncSummaryClinicalNotesLog"></tbody>
                                </table>
                            </div>
                        </div>
                    </div>
    ...
    <div class="modal-box" style="max-width: 680px; width: 95%;">
        <div class="modal-header">
            <div>
                ...
                <p class="pd-transfer-helper-text">Select date range and encounters to generate a clinical transfer summary for the receiving hospital.</p>
            </div>
        ...
        <form id="pdEncounterTransferForm">
            <div class="pd-transfer-card">
                <div style="display: flex; align-items: center; justify-content: space-between; margin-bottom: 8px; flex-wrap: wrap; gap: 8px;">
                    <label class="pd-transfer-section-label">Date Range of Encounters:</label>
                    <div class="pd-transfer-presets" id="pdTransferDatePresets">
                        <button type="button" class="pd-report-btn pd-report-btn-secondary" data-preset="all">All Visits</button>
                        <button type="button" class="pd-report-btn pd-report-btn-secondary" data-preset="30d">Last 30 Days</button>
                        <button type="button" class="pd-report-btn pd-report-btn-secondary" data-preset="90d">Last 90 Days</button>
                        <button type="button" class="pd-report-btn pd-report-btn-secondary" data-preset="1y">Past Year</button>
                    </div>
                </div>

                <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 12px;">
                    <div class="form-group" style="margin-bottom: 0;">
                        <label for="pdTransferStartDate" class="pd-transfer-field-label">Start Date (From):</label>
                        <input type="date" id="pdTransferStartDate" class="form-input" style="height: 32px; font-size: 13px;">
                    </div>
                    <div class="form-group" style="margin-bottom: 0;">
                        <label for="pdTransferEndDate" class="pd-transfer-field-label">End Date (To):</label>
            ...
            <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 12px; margin-bottom: 14px;">
                <div class="form-group" style="margin-bottom: 0;">
                    <label for="pdTransferReceivingHospital" class="pd-transfer-field-label">Receiving Hospital / Facility:</label>
                ...
                <div class="form-group" style="margin-bottom: 0;">
                    <label for="pdTransferReason" class="pd-transfer-field-label">Reason for Transfer / Summary:</label>
            ...
            <div style="margin-bottom: 14px;">
                <div style="display: flex; align-items: center; justify-content: space-between; margin-bottom: 6px;">
                    <label class="pd-transfer-section-label">
                        Encounters Included in Summary (<span id="pdTransferEncounterCount">0</span>):
                    </label>
                    <div style="font-size: 12px; display: flex; gap: 8px;">
                        <a href="#" id="pdTransferSelectAllEncounters" class="pd-transfer-link">Select All</a>
                        <span style="color: var(--border-color);">|</span>
                        <a href="#" id="pdTransferDeselectAllEncounters" class="pd-transfer-link">Deselect All</a>
                    </div>
                </div>

                <div id="pdTransferEncountersList" class="pd-transfer-encounters-list">
                    <p style="color: var(--text-muted); font-size: 12px; padding: 8px 0; text-align: center;">Loading encounters...</p>
                </div>
            </div>

            <div style="margin-bottom: 16px;">
                <label class="pd-transfer-field-label" style="display: block; margin-bottom: 6px;">
                ...
                <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(180px, 1fr)); gap: 8px; font-size: 12px;">
                    <label class="pd-transfer-checkbox-label">
                        <input type="checkbox" id="pdTransferIncBaseline" checked style="accent-color: var(--accent, #0055a4);">
                        <span>Allergies & Diagnoses</span>
                    </label>
                    <label class="pd-transfer-checkbox-label">
                        <input type="checkbox" id="pdTransferIncMeds" checked style="accent-color: var(--accent, #0055a4);">
                        <span>Active Medications</span>
                    </label>
                    <label class="pd-transfer-checkbox-label">
                        <input type="checkbox" id="pdTransferIncVitals" checked style="accent-color: var(--accent, #0055a4);">
                        <span>Vital Signs</span>
                    </label>
                    <label class="pd-transfer-checkbox-label">
                        <input type="checkbox" id="pdTransferIncNotes" checked style="accent-color: var(--accent, #0055a4);">
                        <span>SOAP & Clinical Notes</span>
                    </label>
                    <label class="pd-transfer-checkbox-label">
                        <input type="checkbox" id="pdTransferIncCarePlan" checked style="accent-color: var(--accent, #0055a4);">
                        <span>Care Plan & Instructions</span>
                    </label>
                    <label class="pd-transfer-checkbox-label">
                        <input type="checkbox" id="pdTransferIncBilling" checked style="accent-color: var(--accent, #0055a4);">
    ...
    <div class="modal-box" style="max-width: 720px;">
        ...
        <form id="carePreferenceForm" onsubmit="event.preventDefault();">
            <div style="display: grid; grid-template-columns: 1fr 1fr 1fr; gap: 16px;">
                <div class="form-group">
                    <label class="form-label required">Preference Type</label>
...
<div class="modal-overlay" id="treatmentPreferenceFormModalOverlay">
    <div class="modal-box" style="max-width: 720px;">
        <div class="modal-header">
            <h2>Treatment Intervention Preferences</h2>
            <button type="button" class="modal-close" id="closeTreatmentPreferenceFormModal">&times;</button>
        </div>
        <p class="form-subtitle">Record and review this patient's treatment intervention preferences.</p>

        <div id="treatmentPreferenceSuccessBanner"></div>

        <form id="treatmentPreferenceForm" onsubmit="event.preventDefault();">
            <div style="display: grid; grid-template-columns: 1fr 1fr 1fr; gap: 16px;">
                <div class="form-group">
                    <label class="form-label required">Preference Type</label>
                    <select class="form-input" id="treatmentPreferenceCategory" required>
                        <option value="">Select...</option>
                    </select>
                    <span style="display:block; font-size: 11px; color: var(--text-muted); margin-top: 4px;">LOINC-coded list for FHIR compliance</span>
                </div>
                ...
                <div class="form-group">
                    <label class="form-label required">Date Recorded</label>
                    <input type="datetime-local" class="form-input" id="treatmentPreferenceDate" required>
                </div>

                <div class="form-group">
                    <label class="form-label">Status</label>
                    <select class="form-input" id="treatmentPreferenceStatus">
                        <option value="preliminary">Preliminary</option>
                        <option value="final" selected>Final</option>
                        <option value="amended">Amended</option>
                    </select>
            ...
            <div class="form-group">
                ...
                <div style="display:flex; gap:20px; flex-wrap:wrap; margin-top:6px;">
                    <label style="display:flex; align-items:center; gap:6px; font-weight:400; font-size: 13.5px; color: var(--text-primary);">
                        <input type="radio" name="treatmentPreferenceResponseType" value="coded" checked> Coded Value (from answer list)
                    </label>
                    <label style="display:flex; align-items:center; gap:6px; font-weight:400; font-size: 13.5px; color: var(--text-primary);">
                        <input type="radio" name="treatmentPreferenceResponseType" value="free_text"> Free Text
                    </label>
                    <label style="display:flex; align-items:center; gap:6px; font-weight:400; font-size: 13.5px; color: var(--text-primary);">
                        <input type="radio" name="treatmentPreferenceResponseType" value="yes_no"> Yes/No
                    </label>
                </div>
            </div>
            ...
            <div class="form-group">
                <label class="form-label required">Patient's Preference</label>
                <div id="treatmentPreferenceValueField">
                    <select class="form-input" id="treatmentPreferenceValueInput" disabled>
                        <option value="">Select preference first...</option>
                    </select>
                </div>
            </div>
            ...
            <div class="form-group">
                <label class="form-label">Additional Notes</label>
                <textarea class="form-input" id="treatmentPreferenceNotes" style="height: 70px; resize: vertical;"></textarea>
            </div>

            <div class="form-actions" style="margin-top: 16px;">
                <button type="button" class="btn-secondary" id="treatmentPreferenceFormCancelBtn">Cancel</button>
                <button type="button" class="btn-primary-inline" id="treatmentPreferenceFormSaveBtn">Save Preference</button>
            </div>
        </form>
        ...
        <div class="data-table-wrap">
            <table class="data-table">
                ...
                <tbody id="treatmentPreferencesTableBody">
                    <tr><td colspan="5" class="table-empty">No treatment intervention preferences recorded.</td></tr>
                </tbody>
            </table>
        </div>
...
<div class="modal-overlay" id="clinicalNotesFormModalOverlay">
    <div class="modal-box" style="max-width: 780px;">
        <div class="modal-header">
            <h2>Clinical Notes Form</h2>
            <button type="button" class="modal-close" id="closeClinicalNotesFormModal">&times;</button>
        </div>
        <p class="form-subtitle">Note Details</p>

        <div id="clinicalNotesFormAlert"></div>

        <form id="clinicalNotesForm">
            <div id="clinicalNoteRowsContainer"></div>
...
<div class="modal-overlay" id="clinicalNoteDocumentPickerModalOverlay">
    <div class="modal-box" style="max-width: 640px;">
        <div class="modal-header">
            ...
            <button type="button" class="modal-close" id="closeClinicalNoteDocumentPickerModal">&times;</button>
        </div>

        <div class="form-grid">
            <div class="form-group">
                <label>Search by name:</label>
                <input type="text" class="form-input" id="clinicalNoteDocSearchName" placeholder="Enter document name...">
            </div>
            <div class="form-group">
                <label>Document Type:</label>
                <select class="form-input" id="clinicalNoteDocSearchType">
            ...
            <div class="form-group">
                ...
                <input type="date" class="form-input" id="clinicalNoteDocSearchFromDate">
            </div>
        </div>

        <button type="button" class="btn-primary-inline" id="clinicalNoteDocSearchBtn">Search</button>

        <div class="table-wrap" style="margin-top: 14px;">
            <table class="data-table">
                <tbody id="clinicalNoteDocResultsBody">
        ...
        <div class="form-actions">
            <button type="button" class="btn-secondary" id="cancelClinicalNoteDocPicker">Cancel</button>
            <button type="button" class="login-btn" id="addSelectedClinicalNoteDocs">Add Selected</button>
        </div>
    </div>
</div>

<div class="modal-overlay" id="clinicalNoteResultPickerModalOverlay">
    <div class="modal-box" style="max-width: 640px;">
        <div class="modal-header">
            <h2>Search Procedure Results</h2>
            <button type="button" class="modal-close" id="closeClinicalNoteResultPickerModal">&times;</button>
        </div>

        <div class="form-grid">
            <div class="form-group">
                <label>Search by procedure:</label>
                <input type="text" class="form-input" id="clinicalNoteResultSearchName" placeholder="Enter procedure name...">
            </div>
            <div class="form-group">
                <label>From Date:</label>
                <input type="date" class="form-input" id="clinicalNoteResultSearchFromDate">
            </div>
        </div>

        <button type="button" class="btn-primary-inline" id="clinicalNoteResultSearchBtn">Search</button>

        <div class="table-wrap" style="margin-top: 14px;">
            <table class="data-table">
                <tbody id="clinicalNoteResultResultsBody">
        ...
        <div class="form-actions">
            <button type="button" class="btn-secondary" id="cancelClinicalNoteResultPicker">Cancel</button>
            <button type="button" class="login-btn" id="addSelectedClinicalNoteResults">Add Selected</button>
        </div>
    </div>
</div>
