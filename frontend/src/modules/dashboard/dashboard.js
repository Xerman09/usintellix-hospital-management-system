...
import { PatientsListView } from "../patients/patients-list.view.js?v=68";
import { initPatientsList, restorePatientChartTab, triggerCreateVisit, triggerCurrentVisit, triggerVisitHistory, triggerRecordsHistory, triggerRecordsRequest, triggerFeeSheet, triggerCheckout } from "../patients/patients-list.js?v=68";
...
import { SystemConfigView } from "../system-config/system-config.view.js?v=2";
...
import { SystemDocumentationView } from "../system-documentation/system-documentation.view.js?v=8";
