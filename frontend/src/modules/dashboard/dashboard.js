...
import { PatientsListView } from "../patients/patients-list.view.js?v=49";
...
import { CareCoordinationView } from "../care-coordination/care-coordination.view.js?v=104";
import { initCareCoordination } from "../care-coordination/care-coordination.js?v=104";
