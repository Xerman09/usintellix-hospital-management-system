...
<div class="ann-page">
    <div class="ann-header">
        <div class="ann-title-wrap">
            <h1>Announcements</h1>
            <p class="ann-subtitle">${isAdmin ? 'Create, schedule, and broadcast hospital announcements with images and role targeting.' : 'Official hospital broadcasts, alerts, and scheduled notices for your role.'}</p>
        </div>
        ${isAdmin ? `
