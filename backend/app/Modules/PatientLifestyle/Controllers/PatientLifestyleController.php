...
namespace App\Modules\PatientLifestyle\Controllers;

use App\Core\Controller;
use App\Core\Request;
use App\Core\Session;
use App\Modules\PatientLifestyle\Services\PatientLifestyleService;
use App\Modules\Patients\Models\Patient;
use App\Modules\Providers\Services\ProviderService;

class PatientLifestyleController extends Controller
{
    private PatientLifestyleService $service;
    private ProviderService $providerService;

    public function __construct()
    {
        $this->service = new PatientLifestyleService();
        $this->providerService = new ProviderService();
    }

    /**
     * Get a patient's Lifestyle tab data.
     */
    public function show(): void
    {
        ...
        $this->success($this->service->get($patientId), 'Lifestyle retrieved successfully.');
    }

    /**
     * Save a patient's Lifestyle tab data, replacing the previously
     * recorded set.
     */
