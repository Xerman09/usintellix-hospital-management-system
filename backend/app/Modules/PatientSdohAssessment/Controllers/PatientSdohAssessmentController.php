...
class PatientSdohAssessmentController extends Controller
{
    ...
    /**
     * Get a patient's SDOH Assessment data.
     */
    public function show(): void
    {
        ...
        $this->success($this->service->get($patientId), 'SDOH Assessment retrieved successfully.');
    }

    /**
     * Save a patient's SDOH Assessment data, replacing the previously
     * recorded set.
     */
