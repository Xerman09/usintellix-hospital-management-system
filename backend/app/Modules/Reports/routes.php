...
$router->get('/reports/financial/summary-by-service-code', [ReportController::class, 'financialSummaryByServiceCodeReport'], [
    AuthMiddleware::class,
    [RoleMiddleware::class, ['admin', 'receptionist', 'doctor']]
]);
...
$router->get('/reports/insurance/distribution', [ReportController::class, 'insuranceDistributionReport'], [
    AuthMiddleware::class,
    [RoleMiddleware::class, ['admin', 'receptionist', 'doctor']]
]);
...
$router->get('/reports/insurance/unique-seen-patients', [ReportController::class, 'uniqueSeenPatientsReport'], [
    AuthMiddleware::class,
    [RoleMiddleware::class, ['admin', 'receptionist', 'doctor']]
]);
...
$router->get('/reports/financial/front-receipts', [ReportController::class, 'frontOfficeReceiptsReport'], [
    AuthMiddleware::class,
    [RoleMiddleware::class, ['admin', 'receptionist', 'doctor']]
]);

$router->get('/reports/financial/receipts-summary', [ReportController::class, 'receiptsSummaryReport'], [
    AuthMiddleware::class,
    [RoleMiddleware::class, ['admin', 'receptionist', 'doctor']]
]);
