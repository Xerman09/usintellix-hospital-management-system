...
class AuditLogger
{
    ...
    public const CATEGORY_AMENDMENTS = 'PHI_AMENDMENT';
    public const CATEGORY_BACKUP = 'BACKUP_CONTINGENCY';
    public const CATEGORY_WORKFORCE = 'WORKFORCE_GOVERNANCE';
    public const CATEGORY_DEIDENTIFICATION = 'SAFE_HARBOR_DEIDENTIFICATION';
    public const CATEGORY_HIPAA_GOVERNANCE = 'HIPAA_GOVERNANCE';
    ...
    public const ACTION_AMENDMENT_REQUESTED = 'CREATE_PHI_AMENDMENT_REQUEST';
    public const ACTION_AMENDMENT_UPDATED = 'UPDATE_PHI_AMENDMENT_REQUEST';
    public const ACTION_AMENDMENT_EXTENSION_GRANTED = 'GRANT_AMENDMENT_EXTENSION';
    public const ACTION_AMENDMENT_EXTENSION_NOTICE = 'GENERATE_AMENDMENT_EXTENSION_NOTICE';
    public const ACTION_AMENDMENT_ACCEPTED = 'ACCEPT_PHI_AMENDMENT';
    public const ACTION_AMENDMENT_DENIED = 'DENY_PHI_AMENDMENT';
    public const ACTION_AMENDMENT_DENIAL_NOTICE = 'GENERATE_AMENDMENT_DENIAL_NOTICE';
    public const ACTION_AMENDMENT_DISAGREEMENT_FILED = 'FILE_STATEMENT_OF_DISAGREEMENT';
    public const ACTION_AMENDMENT_REBUTTAL_FILED = 'FILE_STATEMENT_OF_REBUTTAL';
    public const ACTION_AMENDMENT_REGISTRY_EXPORT = 'EXPORT_AMENDMENTS_REGISTRY_CSV';
    public const ACTION_BACKUP_CREATED = 'CREATE_ENCRYPTED_BACKUP';
    public const ACTION_BACKUP_VERIFIED = 'VERIFY_BACKUP_INTEGRITY';
    public const ACTION_BACKUP_DELETED = 'DELETE_BACKUP';
    public const ACTION_DR_DRILL_RECORDED = 'RECORD_DR_RESTORATION_DRILL';
    public const ACTION_DR_DRILL_UPDATED = 'UPDATE_DR_RESTORATION_DRILL';
    public const ACTION_BACKUP_REGISTRY_EXPORT = 'EXPORT_BACKUP_REGISTRY_CSV';
    public const ACTION_DR_REGISTRY_EXPORT = 'EXPORT_DR_DRILL_REGISTRY_CSV';
    public const ACTION_TRAINING_RECORDED = 'RECORD_HIPAA_TRAINING';
    public const ACTION_TRAINING_UPDATED = 'UPDATE_HIPAA_TRAINING';
    public const ACTION_TRAINING_ATTESTATION_EXPORT = 'EXPORT_TRAINING_ATTESTATION';
    public const ACTION_SANCTION_RECORDED = 'RECORD_DISCIPLINARY_SANCTION';
    public const ACTION_SANCTION_UPDATED = 'UPDATE_DISCIPLINARY_SANCTION';
    public const ACTION_SANCTION_DOSSIER_PRINT = 'PRINT_SANCTION_AUDIT_DOSSIER';
    public const ACTION_WORKFORCE_EXPORT_CSV = 'EXPORT_WORKFORCE_GOVERNANCE_CSV';
    public const ACTION_DEID_DATASET_EXPORTED = 'EXPORT_DEIDENTIFIED_DATASET';
    public const ACTION_DEID_ATTESTATION_PRINT = 'PRINT_DEID_ATTESTATION';
    public const ACTION_DEID_REID_KEY_ACCESSED = 'ACCESS_REIDENTIFICATION_VAULT';
    public const ACTION_DEID_REGISTRY_EXPORT = 'EXPORT_DEID_LOG_CSV';
    public const ACTION_HIPAA_OFFICER_UPDATED = 'UPDATE_HIPAA_OFFICER_DESIGNATION';
    public const ACTION_HIPAA_OFFICERS_EXPORT_CSV = 'EXPORT_HIPAA_OFFICERS_CSV';
    public const ACTION_HIPAA_OFFICER_ATTESTATION = 'GENERATE_HIPAA_OFFICER_ATTESTATION';
